  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#181C2A] to-[#181C2A]">
      <div className="bg-[#23263A] rounded-2xl shadow-lg p-8 w-full max-w-md flex flex-col items-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-1">Welcome to CodeSync</h2>
        ...
        <form className="w-full flex flex-col gap-3">
          ...
          <button type="submit" className="w-full bg-[#6C63FF] text-white py-2 rounded-lg font-semibold hover:bg-[#5548c8] transition">Sign in with Email</button>
        </form>
        <div className="text-[#A1A6C8] text-xs mt-4">
          Don't have an account? <a href="/signup" className="text-[#6C63FF] hover:underline">Sign up</a>
        </div>
      </div>
    </div>
  );
