  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 animated-gradient-bg">
      ...
      <div className="flex flex-col items-center mb-4">
        ...
        <h2 className="text-2xl font-extrabold text-white mb-1">Join SyncDev</h2>
        <p className="text-[#A1A6C8] text-sm font-medium">Start collaborating with developers worldwide</p>
      </div>
      {/* Card */}
      <div className="bg-[#23283A] rounded-lg shadow-lg p-6 w-full max-w-md flex flex-col items-center">
        <h3 className="text-2xl font-bold text-white mb-2">Create Account</h3>
        <p className="text-[#A1A6C8] text-base mb-4">Choose your preferred method to get started</p>
        ...
        <form className="w-full flex flex-col gap-2">
          ...
          <input id="fullname" type="text" placeholder="John Developer" required className="px-4 py-3 rounded-lg bg-[#23283A] text-[#A1A6C8] placeholder-[#A1A6C8] focus:outline-none focus:ring-2 focus:ring-[#6C63FF]" />
          ...
          <label className="text-white text-sm font-semibold" htmlFor="confirmPassword">Confirm Password</label>
          <input id="confirmPassword" type="password" placeholder="" required className="px-4 py-3 rounded-lg bg-[#23283A] text-[#A1A6C8] placeholder-[#A1A6C8] focus:outline-none focus:ring-2 focus:ring-[#6C63FF]" />
          <button type="submit" className="w-full bg-[#181C2A] text-white py-3 rounded-lg font-semibold hover:bg-[#23263A] transition mt-2 text-base">Create Account</button>
        </form>
        <div className="text-[#A1A6C8] text-sm mt-4">
          Already have an account? <a href="/login" className="text-[#4F8CFF] hover:underline">Sign in</a>
        </div>
      </div>
      {/* Footer */}
      <div className="text-center text-xs text-[#A1A6C8] mt-8">
        By creating an account, you agree to our{' '}
        <a href="/terms" className="underline hover:text-[#6C63FF]">Terms of Service</a> and{' '}
        <a href="/privacy" className="underline hover:text-[#6C63FF]">Privacy Policy</a>
      </div>
    </div>
  );
};
